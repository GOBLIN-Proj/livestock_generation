...
Ready to contribute? Here's how to set up `livestock_generation` for local development.

1. Download a copy of `livestock_generation` locally.
2. Install `livestock_generation` using `poetry`:
